...
// controller
import { create, read, update, remove, list } from '@src/controllers/subCategory.controllers';

const router = express.Router();

// routes
router.route('/sub-categories').post(authenticate, authorize('admin'), create).get(list);
